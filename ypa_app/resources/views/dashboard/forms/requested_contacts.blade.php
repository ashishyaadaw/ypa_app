            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    <table class="w-full whitespace-no-wrap relative">
                        ...
                        <tbody id="contact-table-body" class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            {{-- fetch data --}}
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        ...
        function printTableBody(startCount, endCount, newData) {
            ...
            for (i; i < totalCount && i < endCount; i++) {
                ...
                $('#contact-table-body').append(`<tr row-id="${element.id}" class="text-gray-700 w-full dark:text-gray-400 contact-row">
        ...
        async function EditContactRow(id) {
            var keys;
            var values;
            var dataToUpdate;
        ...
        async function DeleteContact(id) {
            ...
            await fetch(`http://127.0.0.1:8000/api/contacts/${id}`, {
                ...
                .then(data => {
                    alertMessage('success', 'One contact deleted');
        ...
        async function DeleteContacts(data) {
            ...
            await fetch(`http://127.0.0.1:8000/api/contacts`, {
                ...
                .then(data => {
                    alertMessage('success', 'Selected Contacts deleted!');
        ...
        async function UpdateContact(data) {
            ...
            // "status": "/contact/id"
            // };
            await fetch(`http://127.0.0.1:8000/api/contacts/${data.id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json'
                ...
                .then(data => {
                    alertMessage('success', 'Contact updated successfully!');
        ...
        async function CreateContact(data) {
            ...
            await fetch(`http://127.0.0.1:8000/api/contacts`, {
                ...
                .then(data => {
                    ...
                    PrintContact(0);
                    alertMessage('info', 'Please update contact data!');
        ...
        async function PrintContact(index) {
            await fetch('http://127.0.0.1:8000/api/contacts/')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
...
@push('script')
    ...
    $('.components > ul > li:nth-child(5)').css('color', '#9333EA');
@endpush
