        ...
        <main class="grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-12 md:pb-24">
            <div class="py-6 md:order-1 hidden md:block">
                <picture>
                    ...
                    <img src="/uploads/screening_poonam_tandon.png" alt="Health and well being" class="mix-blend-multiply"
            ...
            <div>
                ...
                <p class="text-lg mt-4 text-slate-600 max-w-xl">
                    Youth Power Association is a non-governmental organization (NGO) dedicated to promoting Health and
                    Well-being among young individuals. Committed to making a positive impact on the lives of the youth, the
                    organization focuses on various aspects of health to empower and uplift communities.
                </p>
