...
@section('title', 'Environment-Protection')
        ...
        <main class="grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-12 md:pb-24">
            <div class="py-6 md:order-1 hidden md:block">
                <picture>
                    ...
                    <img src="/uploads/bg-water.jpg" alt="Astronaut in the air" class="mix-blend-multiply"
            ...
            <div>
                <h1
                    class="text-5xl lg:text-6xl xl:text-7xl h-40 relative font-bold uppercase lg:tracking-tight xl:tracking-tighter">
                    <div class="environment-effect ">
                ...
                <p class="text-lg mt-4 text-slate-600 max-w-xl">
                    Youth Power Association is a dynamic non-governmental organization (NGO) committed to championing
                    environmental protection and sustainable practices. Founded on the belief that the youth play a pivotal
                    role in shaping the future, the organization focuses on harnessing the energy, creativity, and passion
                    of young individuals to address pressing environmental challenges.
                </p>
                <div class="mt-6 flex flex-col sm:flex-row gap-3"> <button
                    ...
                    </button> <a href="/donate/water_conservation" rel="noopener" target="_blank"
