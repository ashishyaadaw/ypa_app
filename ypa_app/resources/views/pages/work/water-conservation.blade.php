        ...
        <main class="grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-12 md:pb-24">
            ...
            <div>
                ...
                <p class="text-lg mt-4 text-slate-600 max-w-xl">
                    Youth Power Association (YPA) is a dedicated non-governmental organization (NGO) committed to the cause
                    of water conservation. Recognizing the critical importance of water as a finite resource, YPA has taken
                    proactive measures to address the growing challenges related to water scarcity and sustainable water
                    management.
                </p>
