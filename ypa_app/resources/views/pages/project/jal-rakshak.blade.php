        ...
        <div class="grid gap-12 sm:gap-20 lg:grid-cols-2">
            ...
            <div class="flex flex-col items-start gap-2">
                <div class="flex items-center rounded-md bg-gray-300 px-3 py-1">
                    ...
                    <p class="text-sm">Bihar & Uttar Pradesh</p>
                </div>
                <p class="text-sm text-gray-500 sm:text-xl"> Water Conservtion</p>
                <!-- Title -->
                <h1 class="mb-6 text-4xl font-bold md:text-6xl lg:mb-8">Jal Rakshak</h1>
                <p class="text-sm text-gray-500 sm:text-xl">Aware people for effective use of water and conservating rain
                    water . Water bodies care and sustain it's life.</p>
                <!-- Divider -->
                ...
                <div class="mb-6 flex flex-col gap-2 text-sm text-gray-500 sm:text-base lg:mb-8">
                    <p>
                        <strong>2019: </strong>Foundation ceremany of YPA started with Jal Rakshak Event
                    </p>
                </div>
                <!-- Link -->
                <a href="#"
            ...
            <div class="min-h-[530px] overflow-hidden rounded-md bg-gray-100">
                <img src="/uploads/jal_rakshak_logo.png" class="mix-blend-multiply " alt="JAAGO" />
            </div>
        </div>
    </div>
    @include('components.blog', ['type' => 'jal_rakshak'])
@endsection
