        ...
        <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
            ...
            <div class="bg-gray-100 p-8 text-center sm:p-10 md:p-16">
                ...
                <p class="mx-auto mb-6 max-w-2xl text-sm text-gray-500 sm:text-base md:mb-10 lg:mb-12">Currently We're not
                    taking request for research program online. Call us for appointment or give your email. We'll
                    inform you as
                    soon as our online registration of research program started. </p>
                <div class="mx-auto mb-4 flex max-w-lg justify-center">
                    <form name="email-form" method="get" class="flex w-full flex-col gap-3 sm:flex-row">
                        <input type="email"
                            class="h-9 w-full rounded-md request-email-input-field border border-solid border-black px-3 py-6 text-sm text-gray-500"
                            placeholder="Enter your email" />
                        <input id="submit_researcher_waitlist_form" type="submit" value="Notify me"
...
@push('script')
    ...
    $('#submit_researcher_waitlist_form').click(function(e) {
    e.preventDefault();
    ...
    var formData = {
    "name": "",
    "description": "FOR RESEARCHER PROGRAM REGISTRATION MAIL REQUEST",
    "email": email,
    "mobile": "",
    "other": "",
    "status": "NOT VERIFIED",
