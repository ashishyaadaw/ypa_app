    ...
    <div class="w-full add-gallery hidden justify-center fixed top-24 bg-gray-100/[0.5]">
        ...
        <form class="forms-group w-full relative max-w-md bg-slate-400 p-3 py-6 rounded-md border border-slate-950">
            ...
            <div class="forms-input-group grid grid-cols-1">
                ...
                <div class="mb-5">
                    <label for="src" class="mb-3 block text-base font-medium text-[#07074D]">
                        Video Link
                    </label>
                    <input type="text" name="src" id="src" placeholder="Video URL"
                        class="w-full gallery-input-field rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">

                    <span id="src-error" class="text-red-700 text-sm hidden">*Please enter video link</span>
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5 sr-only">
                    ...
                    <input type="text" name="add-gallery-type" id="type" placeholder="type" value="video"
                        class="w-full gallery-input-field rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                </div>
                <div class="mb-5 sr-only">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#submit_gallery_form').click(function(event) {
                ...
                var gallery_src = $('input[name="src"]').val();
                if (gallery_src === '') {
                    $('#src-error').fadeIn();
                    return 0;
                } else {
                    sampledata['src'] = gallery_src;
                }
...
@push('script')
    ...
    $('.gallery > ul > li:nth-child(2)').css('color', '#9333EA');
@endpush
