            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    <table class="w-full whitespace-no-wrap relative">
                        ...
                        <tbody id="slide-table-body" class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            {{-- fetch data --}}
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        ...
        function printTableBody(startCount, endCount, newData) {
            ...
            for (i; i < totalCount && i < endCount; i++) {
                ...
                $('#slide-table-body').append(`<tr row-id="${element.id}" class="text-gray-700 w-full dark:text-gray-400 slide-row">
        ...
        async function EditSlideRow(id) {
            var keys;
            var values;
            var dataToUpdate;
        ...
        async function DeleteSlide(id) {
            ...
            await fetch(`http://127.0.0.1:8000/api/slides/${id}`, {
                ...
                .then(data => {
                    alertMessage('success', 'One slide deleted');
        ...
        async function DeleteSlides(data) {
            // var data = {
            //     "title": "NOTICE HERE 4",
            //     "name": "DESCRIPTION",
            //     "date": "2024-10-13",
            ...
            await fetch(`http://127.0.0.1:8000/api/slides`, {
                ...
                .then(data => {
                    alertMessage('success', 'Selected Slides deleted!');
        ...
        async function UpdateSlide(data) {
            ...
            // "status": "/slide/id"
            // };
            await fetch(`http://127.0.0.1:8000/api/slides/${data.id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json'
                ...
                .then(data => {
                    alertMessage('success', 'Slide updated successfully!');
        ...
        async function CreateSlide(data) {
            ...
            await fetch(`http://127.0.0.1:8000/api/slides`, {
                ...
                .then(data => {
                    ...
                    PrintSlide(0);
                    alertMessage('info', 'Please update slide data!');
        ...
        async function PrintSlide(index) {
            await fetch('http://127.0.0.1:8000/api/slides/')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
...
@push('script')
    ...
    $('.components > ul > li:nth-child(1)').css('color', '#9333EA');
@endpush
