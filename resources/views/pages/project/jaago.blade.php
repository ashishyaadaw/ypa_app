    ...
    <div class="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
        ...
        <div class="grid gap-12 sm:gap-20 lg:grid-cols-2">
            ...
            <div class="flex flex-col items-start gap-2">
                ...
                <p class="text-sm text-gray-500 sm:text-xl"> Awareness Program</p>
                <!-- Title -->
                <h1 class="mb-6 text-4xl font-bold md:text-6xl lg:mb-8">JAAGO</h1>
                <p class="text-sm text-gray-500 sm:text-xl">Awareness Program on various issues like Cancer in health
                    sector, Sanitation on Society.</p>
                <!-- Divider -->
